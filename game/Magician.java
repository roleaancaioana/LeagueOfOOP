...
public final class Magician {
    ...
    void updateHeroPowers(final AngelVisitor angelVisitor, final Hero hero,
                          final String verb, final int i) {
        System.out.println(angelVisitor.getName() + " " + verb + hero.getName() + " " + i);
    }

    void updateHeroKilledByAnAngel(final Hero hero, final int i) {
        System.out.println("Player " + hero.getName() + " " + i + " was killed by an angel");
    }

    void updateHeroKilledByAHero(final Hero firstHero, final Hero secondHero,
                                 final int i, final int j) {
        System.out.println("Player " + firstHero.getName() + " " + i + " was killed by "
                + secondHero.getName() + " " + j);
    }

    void updateHeroBroughtToLifeByAnAngel(final Hero hero, final int i) {
